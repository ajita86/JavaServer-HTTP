package com.distrib.http;

import org.junit.jupiter.api.BeforeAll;
import org.junit.jupiter.api.Test;
import org.junit.jupiter.api.TestInstance;

import com.distrib.server.http.BadHttpVersionException;
import com.distrib.server.http.HttpParser;
import com.distrib.server.http.HttpParsingException;
import com.distrib.server.http.HttpRequest;
import com.distrib.server.http.HttpStatusCode;
...
class HttpParserTest {
    ...
    @Test
    void parseHttpRequest() throws BadHttpVersionException {
    ...
    @Test
    void parseHttpRequestBadMethod1() throws BadHttpVersionException {
        try {
    ...
    @Test
    void parseHttpRequestBadMethod2() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
    ...
    @Test
    void parseHttpRequestInvNumItems1() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
    ...
    @Test
    void parseHttpEmptyRequestLine() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
    ...
    @Test
    void parseHttpRequestLineCRnoLF() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
    ...
    @Test
    void parseHttpRequestBadHttpVersion() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
    ...
    @Test
    void parseHttpRequestSupportedHttpVersion1() throws BadHttpVersionException {
        try {
            HttpRequest request = httpParser.parseHttpRequest(
